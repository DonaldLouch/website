...
import { deleteFileFromS3 } from "@/actions/backblaze.functions"
  
export const MediaCard = ({ media }: any) => {
    // const toastID = "toastID"
    // const date = new Date(uploadedOn).toLocaleDateString()
    const { fileID, filePath, uploadedOn, fileExtension, fileKey } = media.PhotographyMedia
    ...
    async function deleteMedia() {
        ...
        const deleteFile = await deleteFileFromS3({ data: {
        ...
        const isFileDeleted = deleteFile.success ? true : false
                ...
                <Grid.Col span={8}>
                    ...
                    <Group justify="space-between" align="center" px="2rem">
                        ...
                        <Group p="0" m="0">
                            ...
                            <Anchor href={`/admin/photo/${id}`} c="var(--secondary)" style={{boxShadow: "var(--mantine-shadow-bsSMSecondary)", borderRadius: "var(--mantine-radius-md)"}} p="1rem"><FontAwesomeIcon icon={["fadl", "pen"]} /></Anchor>
