...
import { GetVideo } from '@/actions/database/GetDatabase.functions'
...
function RouteComponent() {
  ...
  return <VideoPlayer video={video} description={description} playerType="page" isUser={isUser} isAdmin={isAdmin} />
}
