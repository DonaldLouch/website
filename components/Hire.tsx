  ...
  return (
    <SectionCard id="contact" styleType="primaryCard">
      ...
      <Text textAlign="center" fontSize="xl">
        Hello, if you would like you may hire me to do web development or
        digital content production freelancing. You may use the following
        inquiry form below or you may also email me directly and I&#39;ll be
