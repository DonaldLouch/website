    ...
    return (
        <Box bg="black" maxW="100vw" boxShadow={useColorModeValue('bsBoldBlue', 'bsBoldWhite')}>
            <Box as="footer" role="contentinfo" mx="auto" py="10" px={32} color="white">
                <Stack>
                    <Stack direction={{base: 'column', lg: "row"}} spacing="4" align="center" justify="space-between">
                        <Link href="#">
                        <Image
                    ...
                    <Stack direction={{ base: 'column', md: 'row' }} justify={{ base: 'center', md: 'space-between' }} align={{ base: 'center', md: 'flex-start'}}>
                        <Text fontSize="sm" fontWeight="medium" m ="0 1rem">&copy; 1994 -  {new Date().getFullYear()} Donald Louch.</Text>
                        <iframe src="https://donaldlouch.instatus.com/embed-status/dark-md" width="250" height="50" frameBorder="0" scrolling="no"></iframe>
                    </Stack>
                </Stack>
            </Box>
        </Box>
