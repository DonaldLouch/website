...
export default function ViewPhoto({ fileID, fileTitle, filePath }: any) {
    ...
    return (
        <>
            <IconButton variant="portalButton" color="white" p="2rem" mb="1rem" onClick={onOpen} icon={<FontAwesomeIcon icon={["fal", "eye"]} height="100%" color="currentColor" />} aria-label={`view ${fileTitle}`}>Preview Photo</IconButton> 
