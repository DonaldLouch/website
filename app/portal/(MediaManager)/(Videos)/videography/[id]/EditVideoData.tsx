            ...
            <Formik initialValues={initialValues} onSubmit={onSubmit} validationSchema={validationSchema}>
                {({ handleSubmit, values }: any) => (
                    <Stack as="form" onSubmit={handleSubmit as any} rowGap="2.5rem" my="2rem">
                        ...
                        <Button as="a" variant="newFormButton" color="white" leftIcon={<FontAwesomeIcon icon={["fal", "play"]} height="100%" width="100%" color='currentColor' />} href={`/video/${videoData.id}`} >Watch Video</Button>
