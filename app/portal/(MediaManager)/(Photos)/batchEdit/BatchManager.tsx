...
import { Box, Button, Grid, Input, InputGroup, InputLeftElement, Stack, Text, useToast } from "@chakra-ui/react"
...
export default function BatchManager({mediaData, locations, photographyAlbum}: any) {
  ...
  const breadCrumbs = [
    ...
    {"pageLink": "/portal/batchManager", "pageName": "Batch: Photography Manager"},
  ]
