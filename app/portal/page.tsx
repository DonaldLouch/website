      ...
      <Card px="1rem" mt="0">
        ...
        <CardBody>
          <Stack direction="row" justifyContent="center">
            <Button as="a" href={`/portal/photography`} variant="primary" background="primary" color="white" p="1.8rem 2rem" my="1rem !important">Photography Feed Manager</Button>
            <Button as="a" href={`/portal/videography`} variant="primary" background="primary" color="white" p="1.8rem 2rem" my="1rem !important">Videography Feed Manager</Button>
