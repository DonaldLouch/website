  ...
  return (
    <>
      <SectionCard id="password" styleType="primaryCard" m="2rem">
        ...
        <Text>
          To change your password, we will need to initiate a password reset
          process. To start click the below button then follow the instructions
          sent to your email.
        </Text>
        <PrimaryButton
      ...
      <SectionCard id="2FA" styleType="primaryCard" m="2rem">
        ...
        <Text>
          ...
          {isTwoFAEnabled ? "enabled" : "disabled"} on your account.
        </Text>
