...
import { Code, Stack, Anchor, Group, ActionIcon, Text, Flex, Title, Badge, Image, Tooltip, Box, AspectRatio, SimpleGrid, Grid} from "@mantine/core"
                ...
                <Flex direction="column" align={{base: "center", lg: "flex-start"}}>
                    ...
                    <Stack gap="1rem" my="1rem">
                        <Group>
                            ...
                            <Anchor href={videoData.videoFileID.filePath} target="_blank"><Badge leftSection={<FontAwesomeIcon icon={["fal", "link"]} />} color="blue" tt="lowercase">{video.videoFileID.filePath}</Badge></Anchor>
