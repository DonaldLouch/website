                ...
                <Flex direction="column" align={{base: "center", lg: "flex-start"}}>
                    ...
                    <Stack gap="1rem" my="1rem">
                        <Group>
                            ...
                            <Anchor href={videoData.videoFileID.filePath} target="_blank"><Badge leftSection={<HugeIcon name="link-04" />} color="blue" tt="lowercase">{video.videoFileID.filePath}</Badge></Anchor>
