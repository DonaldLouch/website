    ...
    return <>
        ...
        <Box component="form" onSubmit={form.onSubmit(onSubmit)} m="0">
            <Box style={{boxShadow: "var(--mantine-shadow-bsBoldPrimary)", borderRadius: "var(--mantine-radius-md)"}} p="0.5rem 3rem 1rem" my="1rem">
                ...
                <FormInput inputID="websiteName" inputLabel="Website Name" {...form.getInputProps('websiteName')} inputDescription="Please provide the name of your website. Can also be your company name." icon={<HugeIcon name="text-font" variant="twotone" />} isRequired />
                <FormInput inputID="websiteURL" inputLabel="Website URL" {...form.getInputProps('websiteURL')} type="url" inputDescription="The URL may also include a URL that you are hoping to get." icon={<HugeIcon name="link-04" variant="twotone" />} />
                <FormNumber inputID="pages" inputLabel="Number of Expected Pages" inputDescription="How many pages are you expecting?" suffix=" Page(s)"  {...form.getInputProps('pages')} min={0} icon={<HugeIcon name="license" variant="twotone" />} />
            ...
            <Box style={{boxShadow: "var(--mantine-shadow-bsBoldWhite)", borderRadius: "var(--mantine-radius-md)"}} p="0.5rem 3rem 2rem" m="2rem 0 1rem">
                ...
                {project.projectKind === "installO" &&<>
                    <FormInput inputID="scriptName" inputLabel="Script Name" {...form.getInputProps('scriptName')} inputDescription="Please provide the name of the script you would like installed." icon={<HugeIcon name="text-font" variant="twotone" />} isRequired={project.projectKind === "installO"} />
                    <FormInput inputID="scriptURL" inputLabel="Script URL" {...form.getInputProps('scriptURL')} type="url" inputDescription="Please provide the URL to the script that you're wanting installed" icon={<HugeIcon name="link-04" variant="twotone" />} isRequired={project.projectKind === "installO"} />
                </>}
                {project.projectKind === "installDL" &&<Box my="2rem">
                    ...
                    {dLScriptSelected === "other" &&<>
                        <FormInput inputID="dlScriptOtherName" inputLabel="Other Script Name" {...form.getInputProps('dlScriptOtherName')} inputDescription="Please provide the name of the script you would like installed." icon={<HugeIcon name="text-font" variant="twotone" />} isRequired={project.projectKind === "installDL" && dLScriptSelected === "other"} />
                        <FormInput inputID="dlScriptOtherURL" inputLabel="Other Script URL" {...form.getInputProps('dlScriptOtherURL')} type="url" inputDescription="Please provide the URL to the script that you're wanting installed. Or the URL to the website you want replicated" icon={<HugeIcon name="link-04" variant="twotone" />} isRequired={project.projectKind === "installDL"} />
                    </>}
                </Box>}
            ...
            <FormSubmitButton icon={<HugeIcon name="pencil-edit-01" />}>Update Project Details</FormSubmitButton>
        </Box>
    </>
}
