...
export default async function Player({ params, searchParams }: Props) {
    ...
    const playlistDescription = await serialize(playlistData.playlistDescription!, {mdxOptions: {
        development: process.env.NODE_ENV === 'development',
    }}) as MDXRemoteSerializeResult
    const videoDescription = await serialize(currentVideoData.description!, {mdxOptions: {
        development: process.env.NODE_ENV === 'development',
    }}) as MDXRemoteSerializeResult
