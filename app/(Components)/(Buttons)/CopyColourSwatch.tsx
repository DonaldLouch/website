                ...
                <Tooltip label="Click to copy colour swatch">
                    <AspectRatio ratio={1/1} bg={copied ? "none" : colourHex} p="1rem" onClick={copy} style={{ boxShadow: "var(--mantine-shadow-bsBoldWhite)", borderRadius: "var(--mantine-radius-md)" }}>
                        <Stack justify="center" align="center">
                            <Title order={3} fz="1.1rem" style={{ whiteSpace: "nowrap" }} c={copied && colourTitle != "Mirage"  ? colourHex : colourTitle === "Equator" || colourTitle === "Puttuy" || colourTitle === "White Sand" ? "black" : "white"}>{copied ? "Copied" : colourTitle}</Title>
