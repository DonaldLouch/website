                                                    ...
                                                    <AccordionItem border="none" w="100%">
                                                        ...
                                                        <AccordionPanel >
                                                            ...
                                                            <Heading as="h3" fontSize="1.8rem" fontWeight="700" color="white" textDecoration="underline" fontFamily="body">Category</Heading>
                                                                <Box as="section" id="category" pl="1rem">
                                                                    <Link href={`/blog/C/${video.category.catName}`} variant="unstyled"><Tag size='lg' colorScheme='purple' borderRadius='0 1rem' p="1rem" whiteSpace="nowrap" wordBreak="keep-all" width="fit-content" my="1rem">
