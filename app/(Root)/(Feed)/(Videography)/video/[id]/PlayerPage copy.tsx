...
import { Anchor, Accordion, AspectRatio, Box, Button, Divider, Grid, Title, Input, Modal, ModalBody, ModalCloseButton, ModalContent, ModalHeader, ModalOverlay, Slider, Stack, Badge, Text, Avatar, Tabs, ActionIcon, Alert, Group, SimpleGrid, Center, Tooltip, Drawer, CopyButton } from "@mantine/core"
   ...
   const video = videoData
    ...
    return (<>
        ...
        >
            ...
            <Grid w="100%">
                <Grid.Col span={isTheaterMode || isFullscreenMode ? {base: 12, sm: 12} : {base: 12, sm: 12, md: 8.4} }
                    style={{height: "101vh", alignContent: "center", backdropBlur: "60px", boxShadow: "var(--mantine-shadow-bsBoldWhite)"}}
                ...
                ><Stack justify="center" align="center">
                    {video.videoType === "Vertical" && (
                        <AspectRatio 
                            ratio={9/16} 
                            w={
                                isTheaterMode ? "35%" : isFullscreenMode ? "37%" : "50%"
                    ...
                    <Stack color="white" w={video.videoType === "Vertical" ? "50%" : "90%"} p="0rem 1rem" style={{borderRadius: "0 0 0 1rem", backdropFilter: "blur(3rem)", zIndex: 100, display: hide ? "none" : "flex"}} id="videoControls"
                        pos="absolute" 
                        // top="1.5rem"
                        bottom={
                    ...
                    >
                        <Slider 
                            ...
                            label={null}
                        />
                        <Group justify="space-between" m="-0.5rem 0 0" p="0">
                            <Group maw={video.videoType === "Vertical" ? "100%" : "75%"}>
                                ...
                                <Text fz="1rem" fw="900" mx="0rem" hidden={video.videoType === "Vertical"}>{timeLeft}</Text>
                                <Text fz="1rem" fw="900" mx="0rem" hidden={video.videoType === "Vertical"}>|</Text>
                                <Tooltip label={video.title}>
                                    <Title order={2} fz="1rem" fw="300" mx="0rem" lineClamp={1} w="30vw" style={{display: video.videoType === "Vertical" ? "none" : "initial"}}>{video.title}</Title>
                                </Tooltip>
                            </Group>
                            <Group maw={video.videoType === "Vertical" ? "100%" : "25%"}>
