    ...
    return (
        <>
            <Stack w="100vw" h="100vh" background="black" overflow="hidden" color="white" pos="absolute" top="0" left="0" zIndex="sticky" justifyContent="center" alignItems="center" px="2rem">
                ...
                <Text textAlign="center" fontSize="5xl" fontWeight="900" color="secondary" mt="1rem"><FontAwesomeIcon icon={["fal", "traffic-cone"]} color="currentColor" width="7%" shake  /> Under Development</Text>
