                 ...
                 <table class="es-content-body" align="center" cellpadding="0" cellspacing="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:transparent;width:600px">
                   <tr>
                    <td align="left" style="Margin:0;padding-left:20px;padding-right:20px;padding-top:30px;padding-bottom:30px">
                     <table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                           <tr>
                            <td align="center" class="es-m-txt-c" style="padding:0;Margin:0;padding-bottom:10px"><h1 style="Margin:0;line-height:46px;mso-line-height-rule:exactly;font-family:'playfair display', georgia, 'times new roman', serif;font-size:46px;font-style:normal;font-weight:bold;color:#0F111B"><strong>New Job Request</strong></h1></td>
                           </tr>
                           <tr>
                            <td align="center" class="es-m-p0r es-m-p0l" style="Margin:0;padding-top:5px;padding-bottom:5px;padding-left:40px;padding-right:40px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:21px;color:#0F111B;font-size:14px">You’ve received this message because there has been a new <strong>${data.jobType}</strong> job request from ${data.name}${data.company != undefined ? (` from the company, ${data.company}`) : ("")}. This was submitted from the Donald Louch website at <a target="_blank" href="${process.env.NEXTAUTH_URL}" style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:none;color:#764688;font-size:14px">${process.env.NEXTAUTH_URL}</a>.
                            </p>.</td>
                           </tr>
                           <tr>
                           ...
                           <tr>
                             <td align="left" style="Margin:0;padding-left:25px;padding-right:25px;padding-top:0px;padding-bottom:15px">
                              ...
                              <h2 style="Margin:0;line-height:26px;mso-line-height-rule:exactly;font-family:'playfair display', georgia, 'times new roman', serif;font-size:26px;font-style:normal;font-weight:bold;color:#0F111B"><br>Description</h2><br> ${data.description}
                              <h2 style="Margin:0;line-height:26px;mso-line-height-rule:exactly;font-family:'playfair display', georgia, 'times new roman', serif;font-size:26px;font-style:normal;font-weight:bold;color:#0F111B"><br>Contact Info</h2><br>${data.name}${data.company != undefined ? (` from the company, ${data.company}`) : ("")} 
                              <h2 style="Margin:0;line-height:26px;mso-line-height-rule:exactly;font-family:'playfair display', georgia, 'times new roman', serif;font-size:26px;font-style:normal;font-weight:bold;color:#0F111B"><br>Email</h2><br>${data.email} 
                              <h2 style="Margin:0;line-height:26px;mso-line-height-rule:exactly;font-family:'playfair display', georgia, 'times new roman', serif;font-size:26px;font-style:normal;font-weight:bold;color:#0F111B"><br>Phone Number</h2><br>${data.phone} 
                              <h2 style="Margin:0;line-height:26px;mso-line-height-rule:exactly;font-family:'playfair display', georgia, 'times new roman', serif;font-size:26px;font-style:normal;font-weight:bold;color:#0F111B"><br>Budget</h2><br>${data.budget ? (data.budget) : ("Budget was not listed and to be discussed.")}
                             </div>
                            </td>
                           </tr>
                           <tr>
