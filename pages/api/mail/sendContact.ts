                     ...
                     <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                       ...
                       <tr>
                        ...
                        <div style="font-family:lato, 'helvetica neue', helvetica, arial, sans-serif">
                          <h2 style="Margin:0;line-height:26px;mso-line-height-rule:exactly;font-family:'playfair display', georgia, 'times new roman', serif;font-size:26px;font-style:normal;font-weight:bold;color:#0F111B"><br>Information</h2><br>Sent From ${req?.body.name}<${req?.body.email}> 
                          <h2 style="Margin:0;line-height:26px;mso-line-height-rule:exactly;font-family:'playfair display', georgia, 'times new roman', serif;font-size:26px;font-style:normal;font-weight:bold;color:#0F111B"><br>Subject</h2><br>${req?.body.subject} 
                          <h2 style="Margin:0;line-height:26px;mso-line-height-rule:exactly;font-family:'playfair display', georgia, 'times new roman', serif;font-size:26px;font-style:normal;font-weight:bold;color:#0F111B"><br>Message</h2><br>${req?.body.message}
                        </div>
                    </td>
                       </tr>
                       <tr>
