    ...
    if (response.ok) {
      ...
      if (response.status === 500) {
        toast({
          ...
          description: "It seems like an error occurred while trying to add a new embed. Please try again.",
          status: "error",
          duration: 9000,
          isClosable: true,
        })
                ...
                <Metadata
                    ...
                    <Formik initialValues={initialValues} onSubmit={onSubmit} validationSchema={validationSchema}>
                        ...
                        <Stack as="form" onSubmit={handleSubmit as any} px="1rem">
                          ...
                          <FormTextArea inputID="embed" inputLabel="Embed Link" textRows={4} />

                          <FormTextArea inputID="options" inputLabel="Options" textRows={4} />

                          <FormTextArea inputID="note" inputLabel="Notes" textRows={4} />

                          <SubmitButton variant="blackFormButton">Add New Embed</SubmitButton>
                        </Stack>
                        )}
                    </Formik>
                    </Box>
