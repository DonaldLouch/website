          ...
          <SectionCard id="signup" styleType="primaryCard">
            <Grid templateColumns={{base: "100%", md: "30% 70%", lg: "20% 60% 20%"}} gap="2rem" pos="relative" pr={{ base: "initial", md: "5rem"}}>
              <Box as="aside" pos="sticky" top="6rem" h="74vh" id="bio" display={{ base: "none", md: "initial"}}>
                ...
                <Heading as ="h3" mt="1rem" textShadow="3px 2px 4px rgb(193 93 79 / 20%)" fontSize="1.5rem" textAlign="center">{resume.firstName} {resume.middleName} {resume.lastName}</Heading>
                <Text fontSize="sm" color="gray.500" mt="0" textAlign="center">{resume.address}</Text>
                <Stack gap="0.5rem">
                  <Button as="a" variant="portalButton" href={resume.linkedin} w="100%" color={useColorModeValue("black", "white")}>LinkedIn</Button>
                  <Button as="a" variant="portalButton" href="/about#contact" w="100%" color={useColorModeValue("black", "white")}>Contact Me</Button>
                  <Button as="a" variant="portalButton" href={resume.email} w="100%" color={useColorModeValue("black", "white")}>Email Me</Button>
                </Stack>
              </Box>
              ...
              <Box as="article">
                ...
                <Heading textAlign="center" my="1rem" id="skills" textShadow="3px 2px 4px rgb(193 93 79 / 20%)">Skills</Heading>
                <Text fontSize="1.1rem" lineHeight="1.4rem">{resume.skills}</Text>

                <Heading textAlign="center" my="1rem" id="experience" textShadow="3px 2px 4px rgb(193 93 79 / 20%)">Experience</Heading>
                  {resumeExperience.map((experience: any) => (
                    <Accordion allowToggle mt="2rem" mx="auto" w="100%" textDecoration="none" whiteSpace="break-spaces" wordBreak="break-word" key={experience.id}>
                      <AccordionItem border="none">
                          ...
                          <AccordionPanel>
                            <Heading as="h3" my="1rem">{experience.position}</Heading>
                ...
                <Heading textAlign="center" my="1rem" id="education" textShadow="3px 2px 4px rgb(193 93 79 / 20%)">Education</Heading>
                  {resumeEducation.map((education: any) => (
                      <Accordion allowToggle mt="2rem" mx="auto" w="100%" textDecoration="none" whiteSpace="break-spaces" wordBreak="break-word" key={education.id}>
                        <AccordionItem border="none">
                            <AccordionButton bg="backgroundGradient" color="white" borderRadius="0 2rem" p="1.5rem 3rem" fontSize="1.2rem" fontWeight="600" fontFamily="Lato" _hover={{bg: "none", color: "primary"}} outline="none" _expanded={{bg: "primary", color: "white"}}>
                                <Box flex='1' textAlign='left'>
                ...
                <Heading textAlign="center" my="1rem" id="portfolio" textShadow="3px 2px 4px rgb(193 93 79 / 20%)">View My Work</Heading>

                <Stack direction={{base: "column", xl: "row"}} justifyContent="space-between" gap={{base: "0.5rem", xl: "2rem"}}>
                  <Button as="a" variant="portalButton" href="https://github.com/donaldlouch" w="100%" color={useColorModeValue("black", "white")}>Web Production</Button>
                  <Button as="a" variant="portalButton" href="photography" w="100%" color={useColorModeValue("black", "white")}>Photography</Button>
                  <Button as="a" variant="portalButton" href="videography" w="100%" color={useColorModeValue("black", "white")}>Videography</Button>
                  <Button as="a" variant="portalButton" href="/C/graphic" w="100%" color={useColorModeValue("black", "white")}>Graphic Design</Button>
                  {/* <Button as="a" variant="portalButton" href="written" w="100%" color={useColorModeValue("black", "white")}>Written Work</Button> */}
                </Stack>

                <Heading textAlign="center" my="1rem" id="download" textShadow="3px 2px 4px rgb(193 93 79 / 20%)">Download</Heading>
                <Text fontSize="1.1rem" lineHeight="1.4rem">The File Will Be Downloadable Upon <Link href="/about#contact" variant="primary">Request</Link></Text>
  ...
  const postedTime = postedData.toLocaleTimeString('en-US', { hour: 'numeric', minute: '2-digit' }) */}
              ...
              <Box as="aside" pos="sticky" top="6rem" h="74vh" id="menu" display={{ base: "none", lg: "initial"}}>
                <Stack gap="1.4rem" mx="1rem">
                  ...
                  <Button as="a" variant="portalButton" href="#experience" w="100%" color={useColorModeValue("black", "white")}>Experience</Button>
                  <Button as="a" variant="portalButton" href="#education" w="100%" color={useColorModeValue("black", "white")}>Education</Button>
                  <Button as="a" variant="portalButton" href="#portfolio" w="100%" color={useColorModeValue("black", "white")}>Portfolio</Button>
                  <Button as="a" variant="portalButton" href="#download" w="100%" color={useColorModeValue("black", "white")}>Download</Button>
                </Stack>
              </Box>
            </Grid>
          </SectionCard>
...
export async function getServerSideProps() {
  ...
  return { 
      props: { 
          ...
          resumeWorkExperienceHistoryData: JSON.parse(JSON.stringify(resumeWorkExperienceHistoryData)),
